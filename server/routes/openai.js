...
import CodeSnippet from "./CodeSnip.js";
...
//     // Check if the response object is undefined
//     if (response === undefined) {
//       throw new Error("Response object is undefined.");
//     }

//     // Get the generated code snippet from the response
//     const generatedCode = response.data.choices[0].message.content;

//     // Format the code snippet using the CodeSnippet() function
//     const formattedCode = CodeSnippet(generatedCode);

//     // Send the formatted code snippet to the chat room using the ChatEngine API
//     await axios.post(
//       `https://api.chatengine.io/chats/${activeChatId}/messages/`,
//       { text: formattedCode },
//       {
...
//     // Return the generated code snippet in the response
...
//     await axios.post(
//       `https://api.chatengine.io/chats/${activeChatId}/messages/`,
//       { text: CodeSnippet(response.data.choices[0].message.content) },
//       {
//         headers: {
//           "Project-ID": process.env.PROJECT_ID,
//           "User-Name": process.env.BOT_USER_NAME,
